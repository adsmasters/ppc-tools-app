...
const STARTER_TOOLS = ['campaign-creator', 'audit', 'negative-manager', 'invoices', 'contact'];
const ALL_TOOLS = ['campaign-creator', 'audit', 'negative-manager', 'keyword-harvesting', 'wasted-spend', 'bid-optimizer', 'asin-optimizer', 'invoices', 'contact'];
